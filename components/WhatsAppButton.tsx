...
export default function WhatsAppButton() {
    ...
    const message = encodeURIComponent(
        "Hello CA Poonam, I found your website and would like to discuss your services. Could we schedule a consultation?"
    );
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <p className="text-white/80 text-xs">Available for consultation</p>
                                    </div>
                                </div>
                            </div>
                            <motion.button
